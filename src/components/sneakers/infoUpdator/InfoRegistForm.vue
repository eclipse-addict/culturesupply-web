...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      right_img_exist(){
        if(this.right_url != 'https://218.155.159.235:9000/media/images/defaultImg.png'){
      ...
      left_img_exist(){
        if(this.left_url != 'https://218.155.159.235:9000/media/images/defaultImg.png'){
          return true
        }else{
          return false
        }
      ...
      top_img_exist(){
        if(this.top_url != 'https://218.155.159.235:9000/media/images/defaultImg.png'){
          return true
        }else{
          return false
        }
      ...
      bottom_img_exist(){
        if(this.back_url != 'https://218.155.159.235:9000/media/images/defaultImg.png'){
          return true
        }else{
          return false
        }
      ...
      add_img_exist(){
        if(this.add_url != 'https://218.155.159.235:9000/media/images/defaultImg.png'){
          return true
        }else{
          return false
        }
