  ...
  <nav class="navbar navbar-dark navbar-expand-lg bg-black fixed-top">
    <div class="container-fluid header-font">
      <img
        ...
        height="30"
        width="30"
        class="logo ms-2 me-1"
      />
      <a
        class="navbar-brand nav-mouse-over text-white font-weight-bolder"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex me-auto mb-0 mb-lg-0">
          <li class="nav-item mx-3 nav-mouse-over">
            <a class="nav-link text-white" aria-current="page" @click="toHome"
              >Home</a
            >
          </li>
          <li class="nav-item mx-3 nav-mouse-over">
        ...
        />
        <ul
          class="d-flex mb-0 list-unstyled d-none d-sm-none d-md-block d-lg-block"
        >
          <img
            ...
            height="20"
            width="20"
            class="logo ms-2 me-1 nav-mouse-over"
          />
        </ul>
        <ul
          class="d-flex mb-0 list-unstyled d-none d-sm-none d-md-block d-lg-block"
        ...
        <ul class="d-flex mb-0 list-unstyled">
          ...
          <li class="nav-item dropdown" v-else>
            <a
              class="nav-link dropdown-toggle nav-mouse-over ms-3 mt-1"
              @click="toProfile"
              role="button"
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item nav-mouse-over">Raffle History</a>
              </li>
              <li>
                <a class="dropdown-item nav-mouse-over" @click="signoutRequest"
                  >sign out</a
                >
              </li>
            </ul>
